...
// FETCH OLD DATA
$old = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM tbl_admin WHERE id='$id'"));

// STICKY VALUES
$username = $_POST['username'] ?? $old['username'];
$password = $_POST['password'] ?? $old['password'];
$created  = $old['created_at'];  // don't change created_at
$status   = $_POST['status'] ?? $old['status'];
            ...
            <form method="POST" action="">
                <div class="form-grid">
                    ...
                    <div>
                        ...
                        <input type="text" value="<?= $created ?>" readonly />
                    </div>
                ...
                <div class="btn-row">
                    <input type="submit" value="Update Admin" name="btn_updateAdmin">

 ...
 <?php include('./includes/header.php'); ?>
    <main class="main">
      ...
      <section class="table-wrap">
        <div style="padding:18px 20px;display:flex;justify-content:space-between;align-items:center">
          <div>
            <h4 style="margin:20px;color:var(--plum);font-weight:700">All Staff Records</h4>
            <!-- <div style="font-size:.9rem;color:#7a5f66">Latest bookings & statuses</div> -->
          </div>
          <div>
            <a href="staff_in.php">
            <button class="btn btn-sm" style="background:var(--mauve);color:#fff;border:0;border-radius:10px;height: 40px;"><i class="bi-plus"></i>Add Staff</button>
            </a>
          </div>
        </div>
  ...
  <tbody>
    ...
    ?>
      ...
      <td>
<a class="update-btn" href="staff_up.php?id=<?php echo $row['id']; ?>"><i class="bi-pencil"></i></a>
<a class="delete-btn" href="staff_de.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this record?');"><i class="bi-trash"></i></a>
  ...
  <script>
    document.getElementById("staffSearchBox").addEventListener("keydown", function(e) {
    if (e.key === "Enter") {
        if (this.value.trim() === "") {
